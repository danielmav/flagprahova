...
- Feedback client 2026-09-22 (aplicat și pe producție înainte de lansare) (adresă Băicoi, program 08–18, Arhivă înaintea lui Contact, 7 noutăți 2014-2020 mutate în Arhiva 2021-2027 = `Harta::ARHIVA_2021_COPII`, Utile → dosar cu Documente (9081, gol) + Rețete (9082, fostul conținut), documentele se deschid în filă nouă via `fila_noua` din `Context::arbore`): local e aplicat; pe server a fost rulat `storage/migrare/feedback-client-2026-09-22.sql` (gitignored; folosește `legacy_id`, nu id-uri) prin phpMyAdmin — migrarea NU se re-rulează acolo.
